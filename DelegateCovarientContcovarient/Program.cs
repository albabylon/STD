...
namespace DelegateCovarientContcovarient
{
    internal class Program
    {
        static void Main(string[] args)
        {
            ...
            carDelegate = BuildBMW; //  (делегат повзращает родителя, а метод наследник)
            ...
            BwmInfo bmwInfo = GetCarInfo; // контравариантность (делегатпринимает наслденика, а метод родителя)
            BMW bwm = new BMW
            {
                Model = "X6"
            };
